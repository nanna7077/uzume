...
parser.add_argument("--cachedir", type=str, default="/tmp/uzume")
parser.add_argument("--configdir", type=str, default=os.path.join(os.path.expanduser("~/.config"), ".uzume"))
parser.add_argument("--donotlimitcpu", type=bool, default=False)
...
try:
    ...
    server.init(args.configdir, args.cachedir, not args.donotlimitcpu)
